      ...
      {multiline ? (
        ...
        <>
          ...
          <input
            id="input"
            className={clsx(
              "w-full bg-background-light pr-1 text-base text-text-light outline-none placeholder:text-text-light hover:border-light-primary-100 hover:text-light-gray-300 focus:border-light-primary-400 focus:text-text-text-light active:border-light-primary-400 active:text-text-primary",
