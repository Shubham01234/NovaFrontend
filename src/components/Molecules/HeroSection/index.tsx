...
export const HeroSection = ({ bgSrc, children, end}: HeroSectionProps) => {
  ...
  return (
    <div>
      ...
      <div className={`${additionalStyles} `}>
        <div className={`absolute z-40 flex justify-center ${end ?'items-end' : 'items-center' } min-h-[90vh] w-full`}>
          {children}
        </div>
